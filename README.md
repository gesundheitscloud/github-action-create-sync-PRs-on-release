...
<p align="center"><a href="https://github.com/Glumli/create-update-PR-in-forks"><img alt="GitHub Actions status" src="https://github.com/Glumli/create-update-PR-in-forks/workflows/Node%20CI/badge.svg"></a> <a href="https://codecov.io/gh/Glumli/create-update-PR-in-forks/"><img src="https://badgen.now.sh/codecov/c/github/Glumli/create-update-PR-in-forks" alt="Codecov"></a></p>
...
jobs:
  stuff:
    steps:
      - uses: Glumli/create-update-PR-in-forks@v2
        env:
...
You'll notice that the above example has some `{{ mustache }}` variables. Your issue templates have access to everything about the event that triggered the action. [Here is a list of all of the available template variables](https://github.com/Glumli/actions-toolkit#toolscontext).
